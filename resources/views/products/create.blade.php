...
@section('content')
    <section class="py-3 sm:p-5 antialiased">
        ...
        <form action="{{ route('products.store') }}" method="POST"
            class="bg-white dark:bg-gray-800 p-5 mt-4 mb-4 relative shadow-md sm:rounded-lg overflow-hidden w-full"
            ...
            <div class="mb-6 mt-1">
                <label for="ean_code" class="block mb-2 text-md font-medium text-gray-900 dark:text-white">Code
                    Ean</label>
            ...
            <div class="mb-6 mt-1">
                <label for="selling_price" class="block mb-2 text-md font-medium text-gray-900 dark:text-white">Prix
                    de
                    vente</label>
            ...
            <div class="mb-6 mt-1">
                ...
                <textarea name="description" id="description"cols="30" rows="10"
                    class="block p-2.5 w-1/4 text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    {{ old('description') }}
                </textarea>
                @error('description')
                    <div class="text-red-500 mt-2 text-sm">
