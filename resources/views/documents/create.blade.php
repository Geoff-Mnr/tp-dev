    ...
    <section class="py-3 sm:p-5 antialiased ">
        ...
        <form action="{{ route('documents.store') }}" method="POST"
            ...
            <div class="mb-6 mt-1">
                ...
                <select name='customer_id' id='customer_id' multiple class="w-96 h-16 text-2xl font-semibold text-gray-900 dark:text-dark sm:text-3xl md:text-4xl">
            ...
            <div class="mb-6 mt-1">
                <label for="documenttype_id" class="block mb-2 text-md font-medium text-gray-900 dark:text-white">Type de document</label>
                <select name='documenttype_id' id='documenttype_id' multiple class="w-96 h-16 text-2xl font-semibold text-gray-900 dark:text-dark sm:text-3xl md:text-4xl">
            ...
            <div class="mb-6 mt-1">
                <label for="reference" class="block mb-2 text-md font-medium text-gray-900 dark:text-white">reference</label>
            ...
            <div class="mb-6 mt-1">
                <label for="totalhvat" class="block mb-2 text-md font-medium text-gray-900 dark:text-white">Montant Tva inclus</label>
            ...
            <div class="mb-6 mt-1">
                <label for="totalttc" class="block mb-2 text-md font-medium text-gray-900 dark:text-white">Montant Tva inclus</label>
