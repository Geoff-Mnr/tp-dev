            ...
            <div class="bg-white  dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                ...
                <div
                    ...
                    <div
                        ...
                        <a href="{{ route('documents.create') }}" type="button" id="createProductButton"
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                            <tr>
                                ...
                                <th scope="col" class="p-4">Type de document</th>
                                    ...
                                    <td class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                        <div class="flex items-center space-x-4">
                                            ...
                                            <button type="button" data-drawer-target="drawer-read-product-advanced"
                                                ...
                                                <a href="{{ route('documents.show', $document->id) }}">Détails</a>
                                            </button>
